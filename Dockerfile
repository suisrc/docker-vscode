...
RUN S6_URL="https://github.com/just-containers/s6-overlay/releases" &&\
    S6_APP="${S6_URL}/download/v${S6_RELEASE}/s6-overlay-x86_64.tar.xz" &&\
    S6_CFG="${S6_URL}/download/v${S6_RELEASE}/s6-overlay-noarch.tar.xz" &&\
...
ENV HOME=/home/$USERNAME  \
    ...
    PATH="$PATH:/usr/local/openresty/luajit/bin:/usr/local/openresty/nginx/sbin:/usr/local/openresty/bin:/command" \
